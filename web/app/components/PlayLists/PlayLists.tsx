...
interface FetchDataResponse {
    "歌曲列表": [string | number, string, string][];
}
...
const PlaylistDetail = ({setMusicId, pageType}: PlaylistDetailProps) => {
    ...
    const convertData = (data: { [key: string]: any }): PlaylistData => {
        return {
            "歌曲列表": data["歌曲列表"].map((item: any) => ({
                id: item[0],
